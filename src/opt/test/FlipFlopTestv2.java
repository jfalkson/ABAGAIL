...
double[] temp = { 100, 200 , 300, 400,500, 600, 700, 800 };
        ...
        SimulatedAnnealing sa = new SimulatedAnnealing(temperature, cool, hcp);
        ...
        + popSize + " mate= " + popSize/2 + " mutate= "+ popSize/10 + "testingtime is " + testingTime;
